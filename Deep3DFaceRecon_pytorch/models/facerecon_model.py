...
from Deep3DFaceRecon_pytorch.models import networks
from Deep3DFaceRecon_pytorch.models.bfm import ParametricFaceModel
from Deep3DFaceRecon_pytorch.models.losses import perceptual_loss, photo_loss, reg_loss, reflectance_loss, landmark_loss
...
class FaceReconModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--init_path', type=str, default='Deep3DFaceRecon_pytorch/checkpoints/init_model/resnet50-0676ba61.pth')
        parser.add_argument('--use_last_fc', type=util.str2bool, nargs='?', const=True, default=False, help='zero initialize the last fc')
        parser.add_argument('--bfm_folder', type=str, default='Deep3DFaceRecon_pytorch/BFM')
        ...
        if is_train:
            ...
            parser.add_argument('--net_recog_path', type=str, default='Deep3DFaceRecon_pytorch/checkpoints/recog_model/ms1mv3_arcface_r50_fp16/backbone.pth')
    ...
    def __init__(self, opt):
        ...
        self.renderer = MeshRenderer(
            rasterize_fov=fov, znear=opt.z_near, zfar=opt.z_far, rasterize_size=int(2 * opt.center), use_opengl=False
        )
    ...
    def save_mesh(self, name):
        ...
        #print(f'recon_shape = {recon_shape.shape}')
    ...
    def save_coeff(self,name):
        ...
        #print(f'pred_coeffs: {pred_coeffs.items().shape}')
