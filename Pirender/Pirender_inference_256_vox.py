...
def get_netG(checkpoint_path):
    with open("Pirender/configs/renderer_conf.yaml", "r") as f:
...
def generate_expression_params(pose_path, output_path):
    ...
    if int(data["transform_params"][0,0])!=256:
        ratio = 256/data["transform_params"][0,0]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--renderer_checkpoint", type=str, default="Pirender/checkpoints/renderer_checkpoint_256_vox.pt")
